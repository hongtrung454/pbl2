...
Fan::Fan(string id, bool status, Date installDay, Date uninstallDay, Date warrantyDay)
{
    this->ID = id;
    this->status = status;
...
void Fan::setID(string id)
{
    this->ID = id;
}
void Fan::setStatus(bool status)
{
    this->status = status;
}
void Fan::setInstallDay(Date installday)
{
    this->installDay = installday;
}
void Fan::setUninstallDay(Date uninsDay)
{
    this->uninstallDay = uninsDay;
}
void Fan::setWarrantyDay(Date warrantyDay)
{
    this->warrantyDay = warrantyDay;
}
string Fan::getID()
...
Date Fan::getInstallDay()
{
    return this->installDay;
}
Date Fan::getUninstallDay()
{
    return this->uninstallDay;
}
Date Fan::getWarrantyDay()
{
...
ostream &operator <<(ostream & out, const Fan& f)
{
